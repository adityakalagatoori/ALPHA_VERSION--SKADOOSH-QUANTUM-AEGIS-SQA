...
interface ChartDataPoint { key: Date; data: number | null | undefined; }
interface ChartSeries { key: string; data: ChartDataPoint[]; }
...
const METRICS_DATA: MetricInfo[] = [
  { id: 'mttd', Icon: DiamondAlertIcon, label: 'Mean Time to Respond', tooltip: 'Mean Time to Respond', value: '6 Hours', TrendIcon: UpTrendIcon, trendBaseColor: '#E84045', trendStrokeColor: '#F08083', delay: 0 },
  { id: 'irt', Icon: CircleAlertIcon, label: 'Incident Response Time', tooltip: 'Incident Response Time', value: '4 Hours', TrendIcon: UpTrendIcon, trendBaseColor: '#E84045', trendStrokeColor: '#F08083', delay: 0.05 },
  { id: 'ier', Icon: TriangleAlertIcon, label: 'Incident Escalation Rate', tooltip: 'Incident Escalation Rate', value: '10%', TrendIcon: DownTrendIcon, trendBaseColor: '#40E5D1', trendStrokeColor: '#40E5D1', delay: 0.1 },
];
          ...
          {METRICS_DATA.map((metric) => (
            ...
            >
              ...
              <div className="flex gap-2 w-1/2 justify-end items-center">
                <span className="font-semibold text-xl text-black dark:text-white transition-colors duration-300">{metric.value}</span>
