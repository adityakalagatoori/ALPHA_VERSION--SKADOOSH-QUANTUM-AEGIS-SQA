...
const GlassEffect: React.FC<GlassEffectProps> = ({
  ...
  const content = (
    <div
      ...
      style={glassStyle}
    >
      <div className="absolute inset-0 z-0 overflow-hidden rounded-inherit rounded-3xl"
      ...
      <div className="absolute inset-0 z-20 rounded-inherit rounded-3xl overflow-hidden"
...
const GlassButton: React.FC<{ children: React.ReactNode; href?: string }> = ({ children, href }) => (
  <GlassEffect href={href} className="rounded-3xl px-10 py-6 hover:px-11 hover:py-7 hover:rounded-4xl overflow-hidden">
    <div className="transition-all duration-700 hover:scale-95"
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 items-center justify-center w-full">
        ...
        <GlassButton>
          <div className="text-xl text-white"><p>How can I help you today?</p></div>
        </GlassButton>
      </div>
    </div>
  );
